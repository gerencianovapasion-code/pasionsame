                    ...
                    <form action="{{ route('owner.products.update', $product) }}" method="POST" class="space-y-6">
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <select id="type" name="type" required
                                        ...
                                        <option value="physical" {{ old('type', $product->type) === 'physical' ? 'selected' : '' }}>📦 Producto Físico</option>
                                        <option value="digital" {{ old('type', $product->type) === 'digital' ? 'selected' : '' }}>💾 Producto Digital</option>
                                    </select>
                                ...
                                <div>
                                    ...
                                    <x-text-input id="sku" name="sku" type="text" class="mt-1 block w-full" :value="old('sku', $product->sku)" placeholder="Opcional" />
                        ...
                        <div class="border-b border-gray-200 dark:border-gray-700 pb-6">
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <x-text-input id="stock" name="stock" type="number" min="0" class="mt-1 block w-full" :value="old('stock', $product->stock)" :disabled="!old('manage_stock', $product->manage_stock)" />
                                ...
                                <div>
                                    ...
                                    <select id="stock_status" name="stock_status" required
                                        ...
                                        <option value="on_backorder" {{ old('stock_status', $product->stock_status) === 'on_backorder' ? 'selected' : '' }}>En Reserva</option>
                                    </select>
                        ...
                        <div class="border-b border-gray-200 dark:border-gray-700 pb-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="weight" name="weight" type="number" step="0.01" min="0" class="mt-1 block w-full" :value="old('weight', $product->weight)" placeholder="0.00" />
                        ...
                        <div class="flex items-center justify-between pt-4 border-t border-gray-200 dark:border-gray-700">
                            <form action="{{ route('owner.products.destroy', $product) }}" method="POST" onsubmit="return confirm('¿Estás seguro de eliminar este producto? Esta acción no se puede deshacer.');">
                                @csrf
                                @method('DELETE')
